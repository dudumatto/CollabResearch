...
export default function EditProjectPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSuccess(true);
      redirectTimer.current = setTimeout(() => router.push(`/app/projects/${id}`), 1200);
    } catch (err) {
  ...
  return (
    ...
    >
      <div className="pagina-criar-projeto__cabecalho">
        <button type="button" onClick={() => router.push(`/app/projects/${id}`)} className="pagina-criar-projeto__botao-voltar">
          <ArrowLeft size={16} />
          Voltar
        </button>
        <div>
      ...
      <div className="pagina-criar-projeto__conteudo">
        <form onSubmit={handleSubmit} className="formulario-projeto" noValidate>
          ...
          <div className="formulario-projeto__acoes">
            <button type="button" onClick={() => router.push(`/app/projects/${id}`)}
