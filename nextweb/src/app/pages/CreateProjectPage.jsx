  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      redirectTimer.current = setTimeout(() => {
        router.push(id ? `/app/projects/${id}` : "/app/projects");
      }, 1200);
    } catch (err) {
  ...
  return (
    ...
    >
      <div className="pagina-criar-projeto__cabecalho">
        <button type="button" onClick={() => router.push("/app/projects")} className="pagina-criar-projeto__botao-voltar">
          <ArrowLeft size={16} />
          Voltar
        </button>
        <div>
      ...
      <div className="pagina-criar-projeto__conteudo">
        <form onSubmit={handleSubmit} className="formulario-projeto" noValidate>
          ...
          <div className="formulario-projeto__acoes">
            <button
              type="button" onClick={() => router.push("/app/projects")}
