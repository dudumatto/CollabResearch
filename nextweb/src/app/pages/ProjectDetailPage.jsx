...
import {
  ArrowLeft, Users, Clock, BookOpen, Send, Star,
  BarChart2, Eye, CheckCircle, Pencil, Trash2,
  Loader2, AlertTriangle, UserPlus, UserMinus, XCircle,
  MessageSquare, Mail,
} from "lucide-react";
...
export default function ProjectDetailPage() {
  ...
  const openConversation = async (kind) => {
    try {
      ...
      const cid = conversa?.id ?? conversa?.conversationId;
      if (cid) {
        router.push(`/app/chat?conversationId=${cid}`);
      } else {
  ...
  return (
    <div className="pagina-detalhe-projeto">
      <div className="pagina-detalhe-projeto__barra-topo">
        <button onClick={() => router.push("/app/projects")} className="pagina-detalhe-projeto__voltar">
          <ArrowLeft size={16} />
      ...
      <div className="pagina-detalhe-projeto__grade">
        <div className="pagina-detalhe-projeto__conteudo-principal">
          ...
          {isOwner && (
            <div className="detalhe-card">
              <h2 className="detalhe-card__titulo-secao">Inscrições pendentes</h2>
              {inscricoes.length === 0 ? (
        ...
        <div className="pagina-detalhe-projeto__sidebar">
          <div className="card-inscricao">
            <div className="card-inscricao__grade-stats">
              {[
                { icon: Users, label: "Vagas disponíveis", value: `${slots.remaining}/${slots.total}` },
            ...
            <div className="modal-inscricao__corpo">
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={1000}
                  className="modal-inscricao__textarea"
                  placeholder="Conte como foi sua experiência no projeto..."
                />
